...
![Original image](images/original_image.png){width = 33%}
...
![2x2 matrix representation, unprocessed.](images/bw_image.png){width = 33%}
...
![Rank 10 matrix image.](images/image_rank_10.png){width = 33%} ![Rank 25 matrix image.](images/image_rank_25.png){width = 33%} ![Rank 50 matrix image.](images/image_rank_50 copy.png){width = 33%}

![Rank 100 matrix image.](images/image_rank_100.png){width = 33%} ![Rank 200 matrix image.](images/image_rank_200.png){width = 33%} ![Rank 500 matrix image.](images/image_rank_500.png){width = 33%}
